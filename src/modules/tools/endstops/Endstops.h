...
class Endstops : public Module{
    public:
        ...
        bool 	auto_home_limit[6];

    private:
        void home(char axes_to_move, char abc_axes_to_move);
        void do_homing_cartesian(char axes_to_move, char abc_axes_to_move);
        void do_homing_corexy(char axes_to_move);
        void wait_for_homed(char axes_to_move, char abc_axes_to_move);
        ...
        void back_off_home(char axes_to_move, char abc_axes_to_move);
